  ...
  computed: {
    filteredList(){
      ...
      if(this.filter.firstName != ''){
        filteredUsers = filteredUsers.filter(user => user.firstName.toLocaleLowerCase().includes(this.filter.firstName.toLowerCase()))
      }
      if(this.filter.lastName != ''){
        filteredUsers = filteredUsers.filter(user => user.lastName.toLocaleLowerCase().includes(this.filter.lastName.toLowerCase()))
      }
      if(this.filter.username != ''){
        filteredUsers = filteredUsers.filter(user => user.username.toLocaleLowerCase().includes(this.filter.username.toLowerCase()))
      }
      if(this.filter.emailAddress != ''){
        filteredUsers = filteredUsers.filter(user => user.emailAddress.toLocaleLowerCase().includes(this.filter.emailAddress.toLowerCase()))
      }
