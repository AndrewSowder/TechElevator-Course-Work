  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        <tr>
          <td>
            <input type="checkbox" id="selectAll" v-model="selectedAll" v-on:change="selectUser" />
          </td>
          <td>
            <input
              type="text"
    ...
    <button v-on:click.prevent="showForm = true" v-show="!showForm">
      Add New User
    </button>
...
export default {
  ...
  methods: {
    ...
    checkSelectAll(){
      this.selectedAll = this.selectedUserIDs.length === this.users.length;
    },
