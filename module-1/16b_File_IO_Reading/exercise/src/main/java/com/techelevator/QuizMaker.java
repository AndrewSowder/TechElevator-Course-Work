...
public class QuizMaker {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner userInput = new Scanner(System.in)) {
            System.out.println("Enter the file path of the quiz questions");
    ...
    public void askQuestions(Scanner scanner) {
        ...
        System.out.println();
        System.out.println("You got " + totalCorrectAnswers + " answer(s) correct out of a total " + totalQuestionsAsked + " questions asked.");
    }
