...
//        System.out.println();
        ...
        int firstValue = this.getUserInt("Please enter the first number to add:", userInputScanner);
        int secondValue = this.getUserInt("Please enter the second number to add:", userInputScanner);

        int result = firstValue + secondValue;
        System.out.println(firstValue + " + " + secondValue + " = " + result);
    }

    private int getUserInt(String prompt, Scanner userInputScanner){
